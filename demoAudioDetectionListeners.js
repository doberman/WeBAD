...
function showConfiguration() {
  document.querySelector("#SAMPLE_POLLING_MSECS").textContent =
    SAMPLE_POLLING_MSECS;
  document.querySelector("#MAX_INTERSPEECH_SILENCE_MSECS").textContent =
    MAX_INTERSPEECH_SILENCE_MSECS;
  document.querySelector("#MIN_SIGNAL_DURATION").textContent =
    MIN_SIGNAL_DURATION;
  ...
  document.querySelector("#MIN_AVERAGE_SIGNAL_VOLUME").textContent =
...
document.addEventListener("prespeechstart", (event) => {
  ...
  if (!DEFAULT_PARAMETERS_CONFIGURATION.recordingStopped) restartRecording();
});
